...
<head>
    ...
    <title>View Subscribe - Auction Deal Asset</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">Subscriber /</span> View
    </h4>
        <!-- Bootstrap Table with Header - Dark -->
        <div class="card">
            <h5 class="card-header">Total Subscriber <span class="badge bg-primary">
                @if(!empty($list))
                    {{count($list)}}
                @endif
            </span></h5>
                        ...
                        <tr>
                            ...
                            <td >
                                <div class="dropdown d-flex">
                                    ...
                                    <a class="dropdown-item m-0" href="/subscriber/delete/{{$data->id}}" style="width:20%;"><i class="ti ti-trash me-1 text-danger" title="Delete"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
