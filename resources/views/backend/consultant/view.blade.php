...
<head>
    ...
    <title>View Consultant - Auction Deal Asset</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">Consultant /</span> View Consultant
    </h4>
        <!-- Bootstrap Table with Header - Dark -->
        <div class="card">
            <h5 class="card-header">Total Consultant <span class="badge bg-primary">{{count($list)}}</span></h5>
            <div class="table-responsive text-nowrap">
              <table class="table">
                ...
                <tr>
                  <td><img src="../{{$data->profile_img}}" width="50" alt="{{$data->profile_img}}"></td>
                  ...
                  <td>{{$data->email}}</td>
                    ...
                    <td>
                      <div class="dropdown d-flex">
                        @if($data->status == '1')
                            <a class="dropdown-item m-0" href="/consultant/inactive/{{$data->id}}"><i class="fa fa-toggle-on me-1 text-success" style="font-size:18px;"></i></a>
                        @else
                            <a class="dropdown-item m-0" href="/consultant/active/{{$data->id}}"><i class="fa fa-toggle-off me-1 text-danger" style="font-size:18px;"></i></a>
                        @endif
                            <a class="dropdown-item m-0" href="/consultant/edit/{{$data->id}}"><i class="ti ti-pencil me-1 text-primary" title="Edit"></i></a>
                            <a class="dropdown-item m-0" href="/consultant/delete/{{$data->id}}"><i class="ti ti-trash me-1 text-danger" title="Delete"></i></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
