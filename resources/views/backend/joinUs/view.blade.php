...
<head>
    ...
    <title>View Join Us - Auction Deal Asset</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">join Us /</span> View
    </h4>
        <!-- Bootstrap Table with Header - Dark -->
        <div class="card">
            <h5 class="card-header">Total join Us <span class="badge bg-primary">{{count($list)}}</span></h5>
                        ...
                        <tr>
                            ...
                            <td >
                                <div class="dropdown d-flex">
                                    <a class="dropdown-item m-0" href="/join-us/view-in-details/{{$data->id}}" style="width:20%;"><i class="ti ti-eye text-primary" title="View In Details"></i></a>
                                    <a class="dropdown-item m-0" href="/join-us/delete/{{$data->id}}" style="width:20%;"><i class="ti ti-trash me-1 text-danger" title="Delete"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
