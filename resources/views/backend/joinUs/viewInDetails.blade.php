...
<head>
    ...
    <title>Join Us View in Details - Auction Deal Asset</title>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">     
        ...
        <div class="row bg-white pb-4 px-4">
            <div class="col-xl-12 py-4">
                <h5 class="card-header mb-4">View Join Us In Details</h5>
            </div> 
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <p class=" text-capitalize">{{$list->city}}</p>
            </div>

            <div class="col-md-4">
                <label class="fw-bold">State</label>
                <p class=" text-capitalize">{{$list->state}}</p>
            </div>

            <div class="col-md-4">
                <label class="fw-bold">Mobile</label>
                <p class=" text-capitalize">{{$list->contact}}</p>
            </div>
            ...
            <div class="col-lg-12 mt-4">
                <a class="btn btn-danger" href="/join-us/delete/{{$list->id}}">Delete</a>
            </div> 
        </div>
    </div>
        <!-- / Content -->
