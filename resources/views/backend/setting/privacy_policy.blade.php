...
<head>
    ...
    <title>Privacy Policy - Auction Deal Asset</title>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="POST" action="/setting/privacy-policy/update">
                        @csrf
                        <div class="card-body">
                            ...
                            @endif
                            <input type="text" class="form-control mt-3 d-none" name="option_name" value="privacy policy">
                        </div>
