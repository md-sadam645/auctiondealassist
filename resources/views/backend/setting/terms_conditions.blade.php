...
<head>
    ...
    <title>Term & Conditions - Auction Deal Asset</title>
...
@include("backend.layout.header")
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <span class="text-muted fw-light">Settings /</span> Terms & Conditions
        </h4>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="POST" action="/setting/terms-conditions/update" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            @endif
                            <input type="text" class="form-control mt-3 d-none" name="option_name" value="terms & conditions">
                        </div>
