...
<head>
    ...
    <title>Contact Us View in Details - Auction Deal Asset</title>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">     
        ...
        <div class="row bg-white pb-4 px-4">
            <div class="col-xl-12 py-4">
                <h5 class="card-header mb-4">View Contact List In Details</h5>
            </div> 
            <div class="col-md-4">
                <label class="fw-bold">First Name</label>
                <p class=" text-capitalize">{{$list->fname}}</p>
            </div>

            <div class="col-md-4">
                <label class="fw-bold">Last Name</label>
                <p class=" text-capitalize">{{$list->lname}}</p>
            </div>
            ...
            <div class="col-lg-12 mt-4">
                <a class="btn btn-danger" href="/contact-list/delete/{{$list->id}}">Delete</a>
            </div> 
        </div>
    </div>
        <!-- / Content -->
