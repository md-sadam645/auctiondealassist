...
<head>
    ...
    <title>View Contact Us - Auction Deal Asset</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">Contact List /</span> View
    </h4>
        <!-- Bootstrap Table with Header - Dark -->
        <div class="card">
            <h5 class="card-header">Total Contact List <span class="badge bg-primary">{{count($list)}}</span></h5>
              ...
              <table class="table">
                ...
                <tbody class="table-border-bottom-0 view-property text-capitalize">
                    @foreach($list as $data)
                        <tr>
                            <td><strong>{{$data->fname}}</strong></td>
                            <td ><strong>{{$data->lname}}</strong></td>
                            ...
                            <td >
                                <div class="dropdown d-flex">
                                    <a class="dropdown-item m-0" href="/contact-list/view-in-details/{{$data->id}}" style="width:20%;"><i class="ti ti-eye text-primary" title="View In Details"></i></a>
                                    <a class="dropdown-item m-0" href="/contact-list/delete/{{$data->id}}" style="width:20%;"><i class="ti ti-trash me-1 text-danger" title="Delete"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
