...
<head>
    ...
    <title>View Subscription - Auction Deal Asset</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">Subscription /</span> View
    </h4>
        <!-- Bootstrap Table with Header - Dark -->
        <div class="card">
            <h5 class="card-header">Total Subscription <span class="badge bg-primary">{{count($list)}}</span></h5>
            <div class="table-responsive text-nowrap">
              <table class="table">
                ...
                <tr>
                    <td><strong>{{$data->plan_name}}</strong></td>
                    <td><i class="fa fa-inr"></i> {{$data->price}}</td>
                    <td>
                    ...
                    <td>
                      <div class="dropdown d-flex">
                          ...
                          <a class="dropdown-item" style="width:auto !important;" href="/subscription/edit/{{$data->id}}"><i class="ti ti-pencil me-1 text-primary"></i></a>
                          <a class="dropdown-item" style="width:auto !important;" href="/subscription/delete/{{$data->id}}"><i class="ti ti-trash me-1 text-danger"></i></a>
